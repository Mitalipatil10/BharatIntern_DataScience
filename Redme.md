...
In this challenge, we have to a predictive model that answers the question: â€œwhat sorts of people were more likely to survive?â€ using passenger data (ie name, age, gender, socio-economic class, etc).
